...
public class InterfazCentralPacientes extends JFrame {
    ...
    /**
     * Si la lista de pacientes no está vacáa muestra el diálogo para que el usuario seleccione la forma en la que desea realizar la adición del paciente. Si la lista de
    ...
    /**
     * Pide la cádula del paciente que se desea eliminar, si lo elimina lo indica. Si no se elimina el paciente se muestra un mensaje indicándolo.
     */
