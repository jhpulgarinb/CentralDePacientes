...
public class PanelListaPacientes extends JPanel implements ActionListener, ListSelectionListener {
    ...
    public void setPrincipal(InterfazCentralPacientes principal) {
        this.principal = principal;
    }

    @SuppressWarnings("rawtypes")
    public void setListaPacientes(JList listaPacientes) {
        this.listaPacientes = listaPacientes;
        this.listaPacientes = listaPacientes;
    }

    public void setBarraDesplazamientoLista(JScrollPane barraDesplazamientoLista) {
        this.barraDesplazamientoLista = barraDesplazamientoLista;
    }
